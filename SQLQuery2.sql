...
BEGIN
	INSERT INTO [SELECT_NAME_FROM_GROUP].Hechos_Medicion (AUTO_ID, SECTOR_ID, TIPO_SECTOR_ID, TELE_AUTO_NUMERO_VUELTA, TIEMPO_ID, TELE_AUTO_VELOCIDAD, CONSUMO_COMBUSTIBLE_PROMEDIO, MIN_TIEMPO_VUELTA, DESGASTE_CAJA_PROMEDIO, MOTOR_DESGASTE, DIF_PROFUNDIDAD_1, DIF_PROFUNDIDAD_2, DIF_PROFUNDIDAD_3, DIF_PROFUNDIDAD_4, DIF_FRENO_1, DIF_FRENO_2, DIF_FRENO_3, DIF_FRENO_4)
	SELECT M.ID_AUTO, DS.SECTOR_ID, DS.SECTO_TIPO_ID, M.TELE_AUTO_NUMERO_VUELTA, T.TIEMPO_ID, MAX(M.TELE_AUTO_VELOCIDAD), AVG(M.TELE_AUTO_COMBUSTIBLE), MIN(M.TELE_AUTO_TIEMPO_VUELTA), AVG(TCC.TELE_CAJA_DESGASTE), MAX(TM.TELE_MOTOR_POTENCIA) - MIN(TM.TELE_MOTOR_POTENCIA), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
	...
	GROUP BY M.ID_AUTO, DS.SECTOR_ID, DS.SECTO_TIPO_ID, M.TELE_AUTO_NUMERO_VUELTA, T.TIEMPO_ID
END
GO
...
-- Todos los circuitos tienen el mismo promedio. No se si es un error
-- de la base de datos o estamos haciendo algo mal
