...
BEGIN
	...
	SELECT M.ID_AUTO, DS.SECTO_TIPO_ID, M.TELE_AUTO_NUMERO_VUELTA, T.TIEMPO_ID, MAX(M.TELE_AUTO_VELOCIDAD), AVG(M.TELE_AUTO_COMBUSTIBLE), MIN(M.TELE_AUTO_TIEMPO_VUELTA), AVG(TCC.TELE_CAJA_DESGASTE), MAX(TM.TELE_MOTOR_POTENCIA) - MIN(TM.TELE_MOTOR_POTENCIA), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
