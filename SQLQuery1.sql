...
BEGIN
	...
	SELECT DISTINCT M.NEUMATICO_NRO_SERIE, I.ID_PARADA_BOX, E.ID_PARADA_BOX, T.ID_TIPO_NEUMATICO
	FROM [gd_esquema].Maestra AS M
	...
	JOIN (SELECT ID_PARADA_BOX, PARADA_BOX_TIEMPO, PARADA_BOX_VUELTA FROM [SELECT_NAME_FROM_GROUP].Parada_Box) AS I ON I.ID_PARADA_BOX=M.PARADA_INGRESO
	JOIN (SELECT ID_PARADA_BOX, PARADA_BOX_TIEMPO, PARADA_BOX_VUELTA FROM [SELECT_NAME_FROM_GROUP].Parada_Box) AS E ON E.ID_PARADA_BOX=M.PARADA_EGRESO
...
BEGIN
	...
	SELECT DISTINCT P1.ID_POSICION, TELE_FRENO1_TEMPERATURA, TELE_FRENO1_GROSOR_PASTILLA, 1, F1.FRENO_ID FROM [gd_esquema].Maestra AS M1
	...
	WHERE TELE_FRENO1_TEMPERATURA IS NOT NULL AND TELE_FRENO1_GROSOR_PASTILLA IS NOT NULL
		UNION
	SELECT DISTINCT P2.ID_POSICION, TELE_FRENO2_TEMPERATURA, TELE_FRENO2_GROSOR_PASTILLA, 2, F2.FRENO_ID FROM [gd_esquema].Maestra AS M2
	JOIN (SELECT ID_POSICION, DESCRIPCION FROM [SELECT_NAME_FROM_GROUP].Posicion) AS P2 ON P2.DESCRIPCION=M2.TELE_FRENO1_POSICION
	...
	WHERE TELE_FRENO2_TEMPERATURA IS NOT NULL AND TELE_FRENO2_GROSOR_PASTILLA IS NOT NULL
		UNION
	SELECT DISTINCT P3.ID_POSICION, TELE_FRENO3_TEMPERATURA, TELE_FRENO3_GROSOR_PASTILLA, 3, F3.FRENO_ID FROM [gd_esquema].Maestra AS M3
	JOIN (SELECT ID_POSICION, DESCRIPCION FROM [SELECT_NAME_FROM_GROUP].Posicion) AS P3 ON P3.DESCRIPCION=M3.TELE_FRENO1_POSICION
	...
	WHERE TELE_FRENO3_TEMPERATURA IS NOT NULL AND TELE_FRENO3_GROSOR_PASTILLA IS NOT NULL
		UNION
	SELECT DISTINCT P4.ID_POSICION, TELE_FRENO4_TEMPERATURA, TELE_FRENO4_GROSOR_PASTILLA, 4, F4.FRENO_ID FROM [gd_esquema].Maestra AS M4
	JOIN (SELECT ID_POSICION, DESCRIPCION FROM [SELECT_NAME_FROM_GROUP].Posicion) AS P4 ON P4.DESCRIPCION=M4.TELE_FRENO1_POSICION
...
BEGIN
	...
	FROM [gd_esquema].Maestra AS M
	JOIN (SELECT ID_AUTO, AUTO_MODELO, AUTO_NUMERO, ID_PILOTO, ID_ESCUDERIA FROM [SELECT_NAME_FROM_GROUP].Auto) AS A ON A.AUTO_MODELO=M.AUTO_MODELO
...
BEGIN
	INSERT INTO [SELECT_NAME_FROM_GROUP].Medicion (TELE_AUTO_CODIGO, TELE_AUTO_NUMERO_VUELTA, TELE_AUTO_DISTANCIA_CARRERA, TELE_AUTO_DISTANCIA_VUELTA, TELE_AUTO_TIEMPO_VUELTA, TELE_AUTO_POSICION, TELE_AUTO_VELOCIDAD, TELE_AUTO_COMBUSTIBLE, CODIGO_CARRERA, CODIGO_SECTOR, TELE_MOTOR_ID, TELE_CAJA_ID)
	SELECT DISTINCT A.ID_AUTO, M.TELE_AUTO_NUMERO_VUELTA, M.TELE_AUTO_DISTANCIA_CARRERA, M.TELE_AUTO_DISTANCIA_VUELTA, M.TELE_AUTO_TIEMPO_VUELTA, M.TELE_AUTO_POSICION, M.TELE_AUTO_VELOCIDAD, M.TELE_AUTO_COMBUSTIBLE, M.CODIGO_CARRERA, M.CODIGO_SECTOR, TM.TELE_MOTOR_ID, TC.TELE_CAJA_ID
	FROM [gd_esquema].Maestra AS M
	JOIN (SELECT ID_AUTO, AUTO_MODELO, AUTO_NUMERO, ID_PILOTO, ID_ESCUDERIA FROM [SELECT_NAME_FROM_GROUP].Auto) AS A ON A.ID_AUTO=M.TELE_AUTO_CODIGO
	JOIN (SELECT TELE_MOTOR_ID, TELE_MOTOR_POTENCIA, TELE_MOTOR_RPM, TELE_MOTOR_TEMP_ACEITE, TELE_MOTOR_TEMP_AGUA, MOTOR_ID FROM [SELECT_NAME_FROM_GROUP].Telemetria_Motor) AS TM ON M.TELE_MOTOR_POTENCIA=TM.TELE_MOTOR_POTENCIA AND M.TELE_MOTOR_RPM=TM.TELE_MOTOR_RPM AND M.TELE_MOTOR_TEMP_ACEITE=TM.TELE_MOTOR_TEMP_ACEITE AND M.TELE_MOTOR_TEMP_AGUA=TM.TELE_MOTOR_TEMP_AGUA
	JOIN (SELECT TELE_CAJA_ID, TELE_CAJA_RPM, TELE_CAJA_TEMP_ACEITE, TELE_CAJA_DESGASTE, CAJA_CAMBIO_ID FROM [SELECT_NAME_FROM_GROUP].Telemetria_Caja_Cambios) AS TC ON M.TELE_CAJA_RPM=TC.TELE_CAJA_RPM AND M.TELE_CAJA_TEMP_ACEITE=TC.TELE_CAJA_TEMP_ACEITE AND M.TELE_CAJA_DESGASTE=TC.TELE_CAJA_DESGASTE
	WHERE	M.TELE_AUTO_CODIGO IS NOT NULL AND
			...
			M.TELE_AUTO_COMBUSTIBLE IS NOT NULL
END
GO
